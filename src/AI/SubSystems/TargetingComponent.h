...
namespace AI
{
    namespace Subsystem
    {
        ...
        public:
            ...
            {
                return new TargetingComponent(*this);
            }
        ...
        private:
            ...
            TargetingComponent(const TargetingComponent& targ):
                Component(Type),
                targetPosition_(targ.targetPosition_),
                targetEntity_(targ.targetEntity_),
                hasValidTarget_(targ.hasValidTarget_)
            {}
        };
    }
}
