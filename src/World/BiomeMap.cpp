...
namespace World
{
    ...
    float BiomeMap::computePerlinNoise(const Geometry::Vec2Df& position, const Geometry::Vec2Df& perlinCoefficient00, const Geometry::Vec2Df& perlinCoefficient10, const Geometry::Vec2Df& perlinCoefficient01, const Geometry::Vec2Df& perlinCoefficient11)
    {
    ...
    BiomeInterface& BiomeMap::getBiome(const Geometry::Vec2Df& position)
    {
        ...
        float nxy1 = computePerlinNoise(position, perlinCoefs_.at(Geometry::Vec2Di(i,j))[0], perlinCoefs_.at(Geometry::Vec2Di(i+1,j))[0], perlinCoefs_.at(Geometry::Vec2Di(i,j+1))[0], perlinCoefs_.at(Geometry::Vec2Di(i+1,j+1))[0]);
        float nxy2 = computePerlinNoise(position, perlinCoefs_.at(Geometry::Vec2Di(i,j))[1], perlinCoefs_.at(Geometry::Vec2Di(i+1,j))[1], perlinCoefs_.at(Geometry::Vec2Di(i,j+1))[1], perlinCoefs_.at(Geometry::Vec2Di(i+1,j+1))[1]);
