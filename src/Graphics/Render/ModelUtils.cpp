...
namespace Graphics
{
    namespace Render
    {
        ...
        Model3D createCubeModel(const Color& color)
        {
            ...
            faces.push_back(Face(0,1,2,color));
            faces.push_back(Face(0,3,1,color));

            faces.push_back(Face(0,2,3,color));
            faces.push_back(Face(1,4,2,color));

            faces.push_back(Face(2,6,3,color));
            faces.push_back(Face(1,3,5,color));

            faces.push_back(Face(1,5,4,color));
            faces.push_back(Face(5,7,4,color));

            faces.push_back(Face(2,7,6,color));
            faces.push_back(Face(5,6,7,color));

            faces.push_back(Face(2,4,7,color));
            faces.push_back(Face(6,5,3,color));
